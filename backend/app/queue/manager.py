...
class JobManager:
    ...
    def __init__(self, app_state: Any) -> None:
        ...
        try:
            ...
            total_mb = 8192
        self._presets: dict[str, dict[str, Any]] = available_presets(
            app_state.settings, total_mb
        )
    ...
    async def submit_from_upload(
        ...
        job = Job(id=job_id, work_path=work_path, meta=meta, preset=preset)
            ...
            while True:
                ...
                try:
                    ...
                    try:
                        ...
                        log.exception(
                            "update_job(failed) also crashed for job %s", job.id
                        )
                finally:
